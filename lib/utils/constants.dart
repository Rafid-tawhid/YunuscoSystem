...
///api/Finishing/ItemWiseEffi?ProductionDate=2025-11-04
///http://202.74.243.118:8090/api/Dashboard/ProductionStregnth?date=2025-11-04
/////http://202.74.243.118:8090/api/Dashboard/GetMMRRatio?date=2025-11-04
//http://202.74.243.118:8090/api/Dashboard/GetInputRelatedIssues?date=2025-11-04
...
List<Menu> fullModuleList = [
  ...
  Menu(4, 'assets/images/ATTENDANCE-min.png', 'Accounts', false), // ID matched (Accounts is ID 4)
  Menu(14, 'assets/images/button-exim.png', 'Export Import',false), // ID matched // Menu(17, 'assets/images/button-trims.png', 'Trims Sales', false),  // ID matched
  Menu(18, 'assets/images/button-sec.png', 'Settings', false), // ID matched // Menu(5, 'assets/images/button-trims.png', 'Sample', false),        // ID matched
  Menu(0, 'assets/images/ATTENDANCE-min.png', 'Profile', false), // Kept ID 0 (not in moduleList)
  Menu(45, 'assets/images/prodbold.png', 'Production', false), // ID matched
  Menu(46, 'assets/images/report.png', 'Reports', false), // ID matched (assuming you add report.png)

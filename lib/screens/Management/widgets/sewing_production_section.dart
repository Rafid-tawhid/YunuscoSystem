...
class SewingProductionSection extends StatelessWidget {
  ...
  const SewingProductionSection({super.key, this.sewingProduction});
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    GridView.count(
                      ...
                      children: [
                        _buildMetricItem(
                            Icons.timeline, 'Line Running', data.lineRunning),
                        _buildMetricItem(
                            Icons.flag, 'Total Target', data.totalTarget),
                        _buildMetricItem(Icons.timer, 'SMV', data.smv),
                        _buildMetricItem(Icons.check_circle, 'Achieved Qty',
                            data.achieveQty),
                        _buildMetricItem(Icons.percent, 'Achieved %',
                            '${data.achievePercent}%'),
                      ],
                    ),

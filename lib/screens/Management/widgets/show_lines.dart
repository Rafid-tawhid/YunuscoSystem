...
class LineScreen extends StatelessWidget {
    ...
    return Scaffold(
      ...
      body: Consumer<ManagementProvider>(
        builder: (context, provider, _) {
          ...
          if (provider.allDropdownInfoForJobcard!.lines!.isEmpty) {
            return const Center(child: Text('No departments found'));
          }

          return ListView.separated(
            padding: const EdgeInsets.all(16),
            itemCount: provider.allDropdownInfoForJobcard!.lines!.length,
  ...
  void _showDepartmentDetails(BuildContext context, Lines section) {
    showDialog(
      context: context,

class ProductionDashboardModel {
  ...
  ProductionDashboardModel.fromJson(dynamic json) {
...
ProductionDashboardModel copyWith({  List<ProductionData>? productionData,
  List<UnitWiseSewing>? unitWiseSewing,
  List<SewingProduction>? sewingProduction,
  List<MorrisLine>? morrisLine,
  List<FinishProduction>? finishProduction,
  List<UnitWiseSewingY>? unitWiseSewingY,
  List<FinishFifteen>? finishFifteen,
}) => ProductionDashboardModel(  productionData: productionData ?? _productionData,

class ItemEfficiencyModel {
  ...
  ItemEfficiencyModel.fromJson(dynamic json) {
...
ItemEfficiencyModel copyWith({  String? productionDate,
  String? itemName,
  num? totalLine,
  num? quantity,
  num? averageEfficiency,
}) => ItemEfficiencyModel(  productionDate: productionDate ?? _productionDate,
